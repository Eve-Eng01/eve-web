...
const ScheduledEvent = ({ isActive = false }: ScheduledEventProps) => {
  ...
  const formattedEvents = useMemo(() => {
    return scheduledEvents.map((event: Event) => {
    ...
    return (
      <div className="w-full">
        <div className="flex flex-col items-center justify-center py-12">
          <p className="text-red-600 mb-4">Failed to load scheduled events</p>
          <button
  ...
  if (formattedEvents.length === 0) {
    return (
      <EmptyEventCard
        ...
        description="You haven't scheduled any upcoming events. Once you do, they'll appear here for easy access."
