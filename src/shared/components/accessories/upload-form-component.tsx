...
export const UploadFormComponent: FC<UploadFormComponentProps> = ({
  onSubmit,
}) => {
    ...
    <div className="space-y-6">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Upload photos, You can also include links to your portfolio or social
          pages to help clients learn more about what you offer.
        </p>
      </div>
