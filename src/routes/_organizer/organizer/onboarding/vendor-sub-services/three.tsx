...
export const Route = createFileRoute("/_organizer/organizer/onboarding/vendor-sub-services/three")({
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("eventOrganizerNumber", e.target.value)
                    }
                    onKeyPress={(e) =>
                      handleKeyPress("eventOrganizerNumber", e)
                    }
                    readOnly={!isEditable.eventOrganizerNumber}
                    className={`w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 font-medium focus:outline-none pr-12 ${
                      isEditable.eventOrganizerNumber
                        ? "bg-white"
                        : "bg-gray-50"
                    }`}
                  />
