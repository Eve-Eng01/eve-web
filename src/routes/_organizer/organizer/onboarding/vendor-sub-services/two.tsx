...
export const Route = createFileRoute("/_organizer/organizer/onboarding/vendor-sub-services/two")({
  component: VendorTwo,
});

export function VendorTwo({
    ...
    <div className="min-h-screen flex bg-white justify-center items-center">
      <div className="flex flex-col justify-center items-center px-4">
        ...
        <div className="w-full mb-8">
          ...
          <div
            className="text-[#5A5A5A] space-y-2 mb-4"
