  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
        <h3 className="text-sm font-medium text-gray-700">Enter Organizer name</h3>
      ...
      {/* Visibility */}
      <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
        <h3 className="text-base font-semibold text-gray-800">Event Visibility</h3>
        <label className="flex items-start gap-3 cursor-pointer">
          <input type="radio" name="visibility" className="mt-1 w-5 h-5 text-purple-600" />
          <div>
            <p className="font-semibold text-gray-800">Public:</p>
            <p className="text-sm text-gray-600">Anyone can find and buy tickets.</p>
          </div>
        </label>
        <label className="flex items-start gap-3 cursor-pointer">
          <input type="radio" name="visibility" defaultChecked className="mt-1 w-5 h-5 text-purple-600" />
          <div>
            <p className="font-semibold text-gray-800">Private</p>
            <p className="text-sm text-gray-600">Only invited guests with a special link can view.</p>
          </div>
        </label>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          <input type="radio" name="refund" className="mt-1 w-5 h-5 text-purple-600" />
          <div>
            <p className="font-semibold text-gray-800">Automated Refund</p>
            <p className="text-sm text-gray-600">The system processes refunds automatically.</p>
          </div>
        </label>
        <label className="flex items-start gap-3 cursor-pointer">
          <input type="radio" name="refund" defaultChecked className="mt-1 w-5 h-5 text-purple-600" />
          <div className="space-y-3">
            <div>
              <p className="font-semibold text-gray-800">Time-Bound Refund</p>
              <p className="text-sm text-gray-600">Refunds allowed up to a set date before the event.</p>
            </div>
            <div>
              <p className="text-sm text-gray-600 mb-2">Enter the day you intend to make the refund</p>
              <input
                type="text"
                placeholder="7 Days"
      ...
      {/* Publish Settings */}
      <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
        <h3 className="text-base font-semibold text-gray-800">Publish Settings</h3>

        <label className="flex items-start gap-3 cursor-pointer">
          <input type="radio" name="publish" className="mt-1 w-5 h-5 text-purple-600" />
          <div>
            <p className="font-semibold text-gray-800">Publish Now</p>
            <p className="text-sm text-gray-600">Make your event public immediately.</p>
          </div>
        </label>

        <label className="flex items-start gap-3 cursor-pointer">
          <input type="radio" name="publish" defaultChecked className="mt-1 w-5 h-5 text-purple-600" />
          <div className="w-full space-y-3">
            <div>
              <p className="font-semibold text-gray-800">Schedule Publish date</p>
