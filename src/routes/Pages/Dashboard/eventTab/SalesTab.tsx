...
import DataTable from '../../../Accessories/DataTable';
...
const SalesTab = () => {
  ...
  const eventData: EventData = {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1200&h=600&fit=crop&q=80', // Event banner image
    startTime: '10:00 AM',
    endTime: '4:00 PM',
    date: '15 Mar 2025',
  ...
  const generateMockSales = (): Sale[] => {
    ...
    const customers = [
      ...
      'Diana Prince', 'Edward Norton', 'Fiona Apple', 'George Lucas', 'Helen Keller',
      'Ian McKellen', 'Julia Roberts', 'Kevin Hart', 'Laura Croft', 'Michael Jordan',
      'Nancy Drew', 'Oscar Wilde', 'Penelope Cruz', 'Quentin Tarantino', 'Rachel Green',
      'Steve Jobs', 'Tina Fey', 'Uma Thurman', 'Vincent Van Gogh', 'Winston Churchill',
      'Xavier Woods', 'Yoko Ono', 'Zoe Saldana',
    ];
    
    const ticketTypes = ['VIP', 'General Admission', 'Early Bird', 'Premium', 'Standard', 'Student'];
    const statuses: ('completed' | 'pending' | 'refunded')[] = ['completed', 'completed', 'completed', 'pending', 'refunded'];
        ...
        {eventData.imageUrl ? (
          ...
          <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-white/70 text-lg font-medium">No Event Image</p>
            </div>
          </div>
        )}
