...
import SalesTab from "../Dashboard/eventTab/SalesTab";
import OrderListTab from "../Dashboard/eventTab/OrderListTab";
import PayoutsTab from "../Dashboard/eventTab/PayoutsTab";
import SettingsModal from "../../Accessories/SettingsModal";
import DatePickerDropdown from "../../Accessories/DatePickerDropdown";

export const Route = createFileRoute("/Pages/Screens/Sales")({
