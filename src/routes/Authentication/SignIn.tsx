      ...
      <div className="flex-1 bg-white flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-[32px] font-bold text-gray-900 mb-2">Welcome Back To Eve</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              <Link to="/Authentication/ForgetPassword/ForgetPass" className="text-sm text-gray-600">
                <span className="text-[#7417C6] hover:text-[#7417C6] cursor-pointer">Forgot Password?</span>
              </Link>
            </div>
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                ...
                <button onClick={handleLogin} className="text-purple-600 hover:text-purple-700 font-medium">
                  Sign Up
                </button>
              </span>
            </div>
