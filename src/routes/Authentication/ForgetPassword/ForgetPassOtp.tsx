...
interface OtpInputProps {
  ...
  export function RouteComponent() {
    ...
    const isPasswordFormValid = newPassword && confirmPassword && newPassword === confirmPassword && newPassword.length >= 6;
      ...
      <div className="min-h-screen flex">
        ...
        <div className="flex-1 bg-white flex items-center justify-center p-8 relative">
          <div className="w-full max-w-3xl">
            ...
            <div className={`relative overflow-hidden ${isVerified ? 'h-[70vh]' : null} flex flex-col items-center justify-center text-center`}>
              {/* OTP Form */}
              ...
              <div className={`absolute inset-0 flex flex-col items-center justify-center text-center space-y-6 transition-transform duration-700 ease-in-out ${
                isVerified && !isPasswordSet ? 'translate-x-0 opacity-100' : isVerified ? '-translate-x-full opacity-0' : 'translate-x-full opacity-0'
              }`}>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed">
                    Your all-in-one platform for event creators, planners,<br />
              ...
              <div className={`absolute inset-0 flex flex-col items-center justify-center text-center space-y-6 transition-transform duration-700 ease-in-out ${
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-gray-600">
                    <p>Your password has been reset successfully. <br /> You can now log in to your EVE account.</p>
                  </div>
                </div>
