...
export const Route = createFileRoute("/Authentication/ForgetPassword/ForgetPass")({
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                Remember Password?{" "}
                <button onClick={handleLogin} className="text-[#7417C6] hover:text-purple-700 font-medium">
                  Log in
                </button>
              </span>
            </div>
