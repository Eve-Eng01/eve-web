...
export const Route = createFileRoute('/Onboarding/SubServices/Review')({
...
function RouteComponent() {
    ...
    const [profileData, setProfileData] = useState<ProfileData>({
        ...
        portfolioItems: [
            { id: 1, title: "Wedding Setup at Lekki Gardens", images: 6, size: "19.3MB" },
            { id: 2, title: "Wedding Setup at Lekki Gardens", images: 6, size: "19.3MB" },
            { id: 3, title: "Wedding Setup at Lekki Gardens", images: 6, size: "19.3MB" }
        ],
        socialLinks: [
            { id: 1, platform: "Instagram", url: "https://example.com/yourportfolio" },
            { id: 2, platform: "Instagram", url: "https://example.com/yourportfolio" }
        ]
    });
    ...
    const handleFormSubmit = (formData: {
        ...
        const totalSizeInMB = (
          images.reduce((acc, file) => acc + file.size, 0) / (1024 * 1024)
        ).toFixed(2);
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white">
                                ...
                                <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-gray-50 border rounded-lg">
                                                {editingFields.companyName ? (
                                                    ...
                                                    <>
                                                        <span className="text-gray-900">{profileData.companyName}</span>
                                                        <Edit 
                                                            className="w-4 h-4 text-purple-600 cursor-pointer hover:text-purple-700" 
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-gray-50 border rounded-lg">
                                                {editingFields.businessType ? (
                                                    ...
                                                    <>
                                                        <span className="text-gray-900">{profileData.businessType}</span>
                                                        <Edit 
                                                            className="w-4 h-4 text-purple-600 cursor-pointer hover:text-purple-700" 
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label className="block text-sm text-gray-600 mb-1">Vendors Number</label>
                                            <div className="flex items-center justify-between p-3 bg-gray-50 border rounded-lg">
                                                {editingFields.vendorNumber ? (
                                                    ...
                                                    <>
                                                        <span className="text-gray-900">{profileData.vendorNumber}</span>
                                                        <Edit 
                                                            className="w-4 h-4 text-purple-600 cursor-pointer hover:text-purple-700" 
                            ...
                            <div className="bg-white">
                                ...
                                <div className="flex items-center justify-between p-3 bg-gray-50 border rounded-lg">
                                    {editingFields.availability ? (
                                        ...
                                        <>
                                            <span className="text-gray-900">{profileData.availability}</span>
                                            <Edit 
                                                className="w-4 h-4 text-purple-600 cursor-pointer hover:text-purple-700" 
                                        ...
                                        <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 border rounded-lg">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-600">You've uploaded {item.images} image • {item.size}</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                            ...
                            <div className="bg-white">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-2">
                                        <div className="text-gray-600">✱</div>
                                        <h3 className="text-lg font-medium text-gray-900">How you charge for your services</h3>
                                    </div>
                                    <Edit 
                                        className="w-4 h-4 text-purple-600 cursor-pointer hover:text-purple-700" 
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 border rounded-lg">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">Charge clients based on time spent working.</p>
                                        </div>
                                    </div>
                                    <div className="px-4 py-2 border-2 border-purple-600 rounded-lg">
                                        {editingFields.hourlyRate ? (
                                            ...
                                            <span className="text-purple-600 font-medium">{profileData.hourlyRate}</span>
                                        )}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-2">
                                        <div className="text-gray-600">✱</div>
                                        <h3 className="text-lg font-medium text-gray-900">Portfolio/Social Media links</h3>
                                    </div>
                                    <div className="w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center cursor-pointer">
                                        <Plus className="w-4 h-4 text-white" />
                                    </div>
                                ...
                                <div className="space-y-3">
                                    {profileData.socialLinks.map((link) => (
                                        <div key={link.id} className="flex items-center justify-between p-3 bg-gray-50 border rounded-lg">
                                            <div className="flex items-center gap-3">
