...
import { AvaliabilityTypeCardProps, avaliabilityTypes } from "../../../DummyData/data";
import { ServiceOneProps } from "./one";

const AvaliableTypeCard: React.FC<AvaliabilityTypeCardProps> = ({ avaliableType, isSelected, onClick }) => {
  return (
    <div
      onClick={onClick}
      className={`
...
export function ServiceTwo({continue: handleContinue, back: handleGoBack}: ServiceOneProps) {
  ...
  return (
    <div className="min-h-screen flex bg-white justify-center items-center">
      <div className="flex flex-col justify-center items-center px-4">
        ...
        Join a network of trusted vendors and grow your business by connecting with event planners and attendees.
        </p>
