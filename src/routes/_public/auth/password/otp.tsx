...
export function RouteComponent() {
  ...
  const handleSignUp = () => {
    ...
    if (otpCode.length === 6) {
      /* eslint-disable */ console.log("OTP Code:", otpCode);
  ...
  const handleSetNewPassword = () => {
    if (newPassword && confirmPassword && newPassword === confirmPassword) {
      /* eslint-disable */ console.log("Setting new password...");
      // Simulate password reset success
      setTimeout(() => {
        setIsPasswordSet(true);
      }, 500);
    } else {
      /* eslint-disable */ console.log("Passwords do not match or are empty");
    }
  };
  ...
  const handleResendCode = () => {
    ...
    /* eslint-disable */ console.log("Resending OTP code...");
  };
