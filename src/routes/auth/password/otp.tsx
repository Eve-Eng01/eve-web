...
export const Route = createFileRoute("/auth/password/otp")({
...
export function RouteComponent() {
  ...
  const handleSignUp = () => {
    ...
    if (otpCode.length === 6) {
      /* eslint-disable */ console.log(
        ...oo_oo(`3873508007_136_6_136_39_4`, "OTP Code:", otpCode)
      );
  ...
  const handleSetNewPassword = () => {
    if (newPassword && confirmPassword && newPassword === confirmPassword) {
      /* eslint-disable */ console.log(
        ...oo_oo(`3873508007_146_6_146_44_4`, "Setting new password...")
      );
  ...
  const handleResendCode = () => {
    ...
    /* eslint-disable */ console.log(
      ...oo_oo(`3873508007_160_4_160_40_4`, "Resending OTP code...")
    );
  };
  ...
  const handleContinue = () => {
    ...
    /* eslint-disable */ console.log(
      ...oo_oo(`3873508007_165_4_165_47_4`, "Continuing to next screen...")
    );
            ...
            {!isVerified && (
              <>
                ...
                <p className="text-gray-900 font-medium">
                  gabrielemumwen20@gmail.com. enter the code here
                </p>
              </>
            )}
          </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-gray-600">
                  <p>
                    ...
                    now log in to your EVE account.
                  </p>
                </div>
              </div>
