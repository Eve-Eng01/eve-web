...
import { Conversation, Message } from "@components/pages/messaging/conversation-item";

export const Route = createFileRoute("/_vendor/vendor/messages/")({
...
const sampleConversations: Conversation[] = [
  {
    ...
    lastMessage: "Sure thing the services can be provided as fast as you want...",
    timestamp: "1:25 pm",
    unreadCount: 2,
    isOnline: true,
  },
